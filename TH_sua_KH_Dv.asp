...
<%
	...
	sql21="update tblsudungdv set Makh='"&Makh&"',Hoten='"&Hoten&"',Madv='"&Madv&"',tendv='"&tendv&"',soluong='"&soluong&"',ngaysd='"&ngaysd&"' where Makh='"&session("suadoi")&"'"
    ...
    <td width="650" valign="top">
        <table width="68%" border="0" align="center">
          ...
          <tr> 
			...
			<font color="#0000FF">B&#7845;m <a href="Sua_KH_Dichvu.asp">vào &#273;ây</a> 
