...
<%
	...
	sql8="update tbldichvu set Madv='"&Madv&"',tendv='"&tendv&"',donvitinh='"&donvitinh&"',dongia='"&dongia&"' where Madv='"&session("suadoi")&"'"
    ...
    <td width="650" valign="top">
        <table width="68%" border="0" align="center">
          ...
          <tr> 
			...
			<font color="#0000FF">B&#7845;m <a href="Sua_Dichvu.asp">vào &#273;ây</a> 
