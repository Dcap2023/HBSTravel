...
<%
	...
	quyen=request("opt")
	sql5="update nguoidung set tennd='"&tennd&"',matkhau='"&matkhau&"',quyen='"&quyen&"' where tennd='"&session("suadoi")&"'"
    ...
    <td width="650" valign="top">
        <table width="62%" border="0" align="center">
          <tr> 
			...
			S&#7917;a &#273;&#7893;i ng&#432;&#7901;i dùng thành công...</font></b></td>
          </tr>
          <tr> 
            <td width="35%">&nbsp;</td>
            <td width="47%">&nbsp;</td>
          ...
          <tr> 
			...
			<font color="#0000FF">B&#7845;m <a href="SuaDoiNguoiDung.asp">vào &#273;ây</a> 
