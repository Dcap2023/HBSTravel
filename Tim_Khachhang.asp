...
<form name="form19" method="post" action="TH_Tim_KH.asp">
	<tr>
    ...
    <td width="650" valign="top">
        <table width="75%" border="0" align="center">
          <tr> 
			...
			<font size="+5" color="#0000FF">Tìm khách hàng</font></td>
          </tr>
          <tr> 
            <td width="32%">&nbsp;</td>
            <td width="66%">&nbsp;</td>
...
<table border="0" width="100%" id="table3" height="39" bgcolor="#78D435"><!--#include file="ketnoi.inc"-->
