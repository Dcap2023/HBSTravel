...
<table border="0" width="100%" id="table1" height="655">
	...
	<tr>
        ...
        <tr> 
          <td colspan="4" bgcolor="#78D435"><b><font size="5" color="#0000FF">S&#7917;a &#273;&#7893;i 
			thông tin phòng...</font></b></td>
        </tr>
        <tr> 
          <td width="33%">&nbsp;</td>
          <td width="31%">&nbsp;</td>
        ...
        <tr bgcolor="#99FFCC"> 
          ...
          <td bgcolor="#78D435">
			<p align="center"><font color="#0000FF"><b>Tên lo&#7841;i</b></font></td>
        ...
        <tr bgcolor="#00FF99"> 
          ...
          <td height="22" bgcolor="#78D435"><font color="#0000FF"><%=rs("tenloai")%></td>
          <td colspan="2" bgcolor="#78D435">
			<p align="center"><b>
			<a href="TH_suaphong.asp?sophong=<%=rs("sophong")%>">
