...
<table border="0" width="100%" id="table1" height="655">
	...
	<tr>
		...
		<td width="650" valign="top"><table width="62%" border="0" align="center">
        <tr> 
          <td colspan="3" bgcolor="#78D435"><font size="5" color="#0000FF">Xóa ng&#432;&#7901;i dùng...</font></td>
        </tr>
        <tr> 
          <td width="55%">&nbsp;</td>
          <td width="27%">&nbsp;</td>
        ...
        <tr bgcolor="#99FFCC"> 
          <td bgcolor="#78D435">
			<p align="center"><font color="#0000FF"><b>Tên truy c&#7853;p</b></font></td>
		...
		%>
        <tr bgcolor="#00FF99"> 
          <td height="22" bgcolor="#78D435"><font color="#0000FF"><%=rs("tennd")%></td>
          <td colspan="2" bgcolor="#78D435">
			<p align="center"><b>
			<a href="XoaNguoiDung_process.asp?tennd=<%=rs("tennd")%>">
